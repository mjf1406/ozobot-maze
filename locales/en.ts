export default {
  ...
  "form_title": "Maze Title",
  "form_title_placeholder": "Enter maze title",
  ...
  "form_page_size_desc": "Generally, as the paper size increases, so does the difficulty of the activity as it eases constraints on the generation algorithm.",
  "form_difficulty": "Difficulty",
  "difficulty_very_easy": "Level 1",
  "difficulty_easy": "Level 2",
  "difficulty_easy_medium": "Level 3",
  "difficulty_medium": "Level 4",
  "difficulty_medium_hard": "Level 5",
  "difficulty_hard": "Level 6",
  "difficulty_very_hard": "Level 7",
  "difficulty_super_hard": "Level 8",
  "difficulty_extreme": "Level 9",
